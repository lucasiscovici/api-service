...
class CreateIndexApiServiceCommand(sublime_plugin.WindowCommand):
    ...
    def run(self, paths=[]):
        ...
        fileToCreate = '{}{}index.js'.format(path, delim)
    ...
    def create_store(self, fileToCreate):
        ...
        delim = os.path.sep
        fileToCopy = '{}{}index.js.template'.format(me, delim)
        copyanything(fileToCopy, fileToCreate)


class CreateFeatApiServiceCommand(sublime_plugin.WindowCommand):
    def get_path(self, paths):
        if paths:
            return paths[0]
        # DEV: On ST3, there is always an active view.
    ...
    def search_input(self):
        self.window.show_input_panel("Feature name: ", '', self.run_search, None, None)
    ...
    def replace_pattern(self, text, filename):
        ...
        filedata = filedata.replace('{{FEATURE_NAME}}', text)
    ...
    def create_dir(self, dirToCreate, text):
        ...
        # self.replace_pattern(text, '{}{}commands.js'.format(dirToCreate, delim))
